...
import 'package:constatn/menu/report/views/insurrance/add_vehicle_insurance_view.dart';
import 'package:constatn/menu/report/widgets/insurance_card_widget.dart';
                  ...
                  child: InsuranceCardWidget(
                    ...
                    onClicked: () {
                      Navigator.push<List<VehicleDataEntity>?>(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AddVehicleInsuranceView(
                            vehicleDataEntity: vehicles[index],
                          ),
                        ),
                      ).then((value) {
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed:
                      vehicles.any((element) => element.insuranceName == null)
                          ? null
                          : () {
                              updateReportCubit.updateReportStep(
